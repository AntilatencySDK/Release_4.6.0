	...
	namespace Alt {
		namespace Environment {
			namespace Sides {
				...
				void setEdgeMarkers(int32_t edgeId, const std::vector<float>& positions) {
				...
				*/
				struct IEnvironmentData : Antilatency::InterfaceContract::IInterface {
					...
					void setEdgeMarkers(int32_t edgeId, const std::vector<float>& positions) {
						...
						handleExceptionCode((reinterpret_cast<VMT*>(this->_object))->setEdgeMarkers(edgeId, positionsMarshaler));
					}
					std::string serialize() {
						std::string result;
						auto resultMarshaler = Antilatency::InterfaceContract::Details::ArrayOutMarshaler::create(result);
		...
		namespace Details {
			...
			public:
				...
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL setEdgeMarkers(int32_t edgeId, Antilatency::InterfaceContract::Details::ArrayInMarshaler::Intermediate positions) {
					try {
						this->_object->setEdgeMarkers(edgeId, positions);
					}
					catch (...) {
						return Antilatency::InterfaceContract::handleRemapException(this->_object);
					}
	...
	namespace Alt {
		namespace Environment {
			namespace Sides {
				...
				Antilatency::Alt::Environment::Sides::IEnvironmentData deserialize(const std::string& environmentData) {
