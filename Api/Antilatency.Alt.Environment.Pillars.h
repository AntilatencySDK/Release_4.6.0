	...
	namespace Alt {
		namespace Environment {
			namespace Pillars {
				...
				Antilatency::Alt::Environment::Pillars::IScheme getSchemeByName(const std::string& name) {
					throw std::logic_error{"Method ILibrary.getSchemeByName() is not implemented."};
				}
				*/
				struct ILibrary : Antilatency::Alt::Environment::IEnvironmentConstructor {
					struct VMT : Antilatency::Alt::Environment::IEnvironmentConstructor::VMT {
						...
						virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL getSchemeByName(Antilatency::InterfaceContract::Details::ArrayInMarshaler::Intermediate name, Antilatency::Alt::Environment::Pillars::IScheme& result) = 0;
						static constexpr Antilatency::InterfaceContract::InterfaceID ID() {
					...
					Antilatency::Alt::Environment::Pillars::IScheme getSchemeByName(const std::string& name) {
						...
						handleExceptionCode((reinterpret_cast<VMT*>(this->_object))->getSchemeByName(nameMarshaler, result));
						return result;
					}
				};
			} //namespace Pillars
	...
	namespace InterfaceContract {
		namespace Details {
			...
			public:
				...
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL getSchemeByName(Antilatency::InterfaceContract::Details::ArrayInMarshaler::Intermediate name, Antilatency::Alt::Environment::Pillars::IScheme& result) {
					try {
						result = this->_object->getSchemeByName(name);
					}
					catch (...) {
						return Antilatency::InterfaceContract::handleRemapException(this->_object);
					}
