...
namespace Antilatency.Alt.Environment.Pillars {
	...
	public interface ILibrary : Antilatency.Alt.Environment.IEnvironmentConstructor {
		...
		Antilatency.Alt.Environment.Pillars.IScheme getSchemeByName(string name);
	}
}
public static partial class QueryInterfaceExtensions {
...
namespace Antilatency.Alt.Environment.Pillars {
	...
	namespace Details {
		public class ILibraryWrapper : Antilatency.Alt.Environment.Details.IEnvironmentConstructorWrapper, ILibrary {
			...
			public Antilatency.Alt.Environment.Pillars.IScheme getSchemeByName(string name) {
				Antilatency.Alt.Environment.Pillars.IScheme result;
				System.IntPtr resultMarshaler;
				var nameMarshaler = Antilatency.InterfaceContract.Details.ArrayInMarshaler.create(name);
				var interfaceContractExceptionCode = (_VMT.getSchemeByName(_object, nameMarshaler, out resultMarshaler));
		...
		public class ILibraryRemap : Antilatency.Alt.Environment.Details.IEnvironmentConstructorRemap {
			public new struct VMT {
				...
				public delegate Antilatency.InterfaceContract.ExceptionCode getSchemeByNameDelegate(System.IntPtr _this, Antilatency.InterfaceContract.Details.ArrayInMarshaler.Intermediate name, out System.IntPtr result);
				#pragma warning disable 0649
				public serializeDelegate serialize;
				public deserializeDelegate deserialize;
				public getSchemeByNameDelegate getSchemeByName;
				#pragma warning restore 0649
			}
			public new static readonly NativeInterfaceVmt NativeVmt;
			...
			#if __MonoCS__
				[MonoPInvokeCallback(typeof(VMT.getSchemeByNameDelegate))]
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getSchemeByName(System.IntPtr _this, Antilatency.InterfaceContract.Details.ArrayInMarshaler.Intermediate name, out System.IntPtr result) {
				try {
					var obj = GetContext(_this) as ILibrary;
					var resultMarshaler = obj.getSchemeByName(name);
					result = Antilatency.InterfaceContract.Details.InterfaceMarshaler.ManagedToNative<Antilatency.Alt.Environment.Pillars.IScheme>(resultMarshaler);
				}
				catch (System.Exception ex) {
					result = default(System.IntPtr);
			...
			protected static new void AppendVmt(System.Collections.Generic.List<object> buffer) {
				...
				vmt.getSchemeByName = getSchemeByName;
				buffer.Add(vmt);
			}
