...
namespace Antilatency.Alt.Environment.Sides {
	[Guid("2db72a30-0811-4784-9875-fedaebae72c9")]
	[Antilatency.InterfaceContract.InterfaceId("2db72a30-0811-4784-9875-fedaebae72c9")]
	public interface IEnvironmentData : Antilatency.InterfaceContract.IInterface {
		...
		void setEdgeMarkers(int edgeId, float[] positions);
		string serialize();
	}
}
public static partial class QueryInterfaceExtensions {
	public static readonly System.Guid Antilatency_Alt_Environment_Sides_IEnvironmentData_InterfaceID = new System.Guid("2db72a30-0811-4784-9875-fedaebae72c9");
	public static void QueryInterface(this Antilatency.InterfaceContract.IUnsafe _this, out Antilatency.Alt.Environment.Sides.IEnvironmentData result) {
		var guid = Antilatency_Alt_Environment_Sides_IEnvironmentData_InterfaceID;
		System.IntPtr ptr = System.IntPtr.Zero;
		_this.QueryInterface(ref guid, out ptr);
		if (ptr != System.IntPtr.Zero) {
			result = new Antilatency.Alt.Environment.Sides.Details.IEnvironmentDataWrapper(ptr);
		}
		else {
			result = null;
		}
	}
	public static void QueryInterfaceSafe(this Antilatency.InterfaceContract.IUnsafe _this, ref Antilatency.Alt.Environment.Sides.IEnvironmentData result) {
...
namespace Antilatency.Alt.Environment.Sides {
	namespace Details {
		public class IEnvironmentDataWrapper : Antilatency.InterfaceContract.Details.IInterfaceWrapper, IEnvironmentData {
			...
			public void setEdgeMarkers(int edgeId, float[] positions) {
				var positionsMarshaler = Antilatency.InterfaceContract.Details.ArrayInMarshaler.create(positions);
				var interfaceContractExceptionCode = (_VMT.setEdgeMarkers(_object, edgeId, positionsMarshaler));
		...
		public class IEnvironmentDataRemap : Antilatency.InterfaceContract.Details.IInterfaceRemap {
			public new struct VMT {
				...
				public delegate Antilatency.InterfaceContract.ExceptionCode setEdgeMarkersDelegate(System.IntPtr _this, int edgeId, Antilatency.InterfaceContract.Details.ArrayInMarshaler.Intermediate positions);
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode setEdgeMarkers(System.IntPtr _this, int edgeId, Antilatency.InterfaceContract.Details.ArrayInMarshaler.Intermediate positions) {
				try {
					var obj = GetContext(_this) as IEnvironmentData;
					obj.setEdgeMarkers(edgeId, positions.toArray<float>());
				}
				catch (System.Exception ex) {
					return handleRemapException(ex, _this);
				}
...
namespace Antilatency.Alt.Environment.Sides {
	[Guid("f43eab81-3758-4b92-99ee-387475f16e66")]
	[Antilatency.InterfaceContract.InterfaceId("f43eab81-3758-4b92-99ee-387475f16e66")]
	public interface ILibrary : Antilatency.Alt.Environment.IEnvironmentConstructor {
		Antilatency.Alt.Environment.Sides.IEnvironmentData createEnvironmentData();
		Antilatency.Alt.Environment.Sides.IEnvironmentData deserialize(string environmentData);
	}
}
public static partial class QueryInterfaceExtensions {
	public static readonly System.Guid Antilatency_Alt_Environment_Sides_ILibrary_InterfaceID = new System.Guid("f43eab81-3758-4b92-99ee-387475f16e66");
	public static void QueryInterface(this Antilatency.InterfaceContract.IUnsafe _this, out Antilatency.Alt.Environment.Sides.ILibrary result) {
		var guid = Antilatency_Alt_Environment_Sides_ILibrary_InterfaceID;
		System.IntPtr ptr = System.IntPtr.Zero;
		_this.QueryInterface(ref guid, out ptr);
		if (ptr != System.IntPtr.Zero) {
			result = new Antilatency.Alt.Environment.Sides.Details.ILibraryWrapper(ptr);
		}
		else {
			result = null;
		}
	}
	public static void QueryInterfaceSafe(this Antilatency.InterfaceContract.IUnsafe _this, ref Antilatency.Alt.Environment.Sides.ILibrary result) {
		Antilatency.Utils.SafeDispose(ref result);
		var guid = Antilatency_Alt_Environment_Sides_ILibrary_InterfaceID;
		System.IntPtr ptr = System.IntPtr.Zero;
		_this.QueryInterface(ref guid, out ptr);
...
namespace Antilatency.Alt.Environment.Sides {
	public static class Library{
	    ...
	    [DllImport(Antilatency.InterfaceContract.LibraryPaths.AntilatencyAltEnvironmentSides)]
	    #else
	    [DllImport("AntilatencyAltEnvironmentSides")]
	    #endif
	...
	namespace Details {
		public class ILibraryWrapper : Antilatency.Alt.Environment.Details.IEnvironmentConstructorWrapper, ILibrary {
			...
			public Antilatency.Alt.Environment.Sides.IEnvironmentData createEnvironmentData() {
				Antilatency.Alt.Environment.Sides.IEnvironmentData result;
				System.IntPtr resultMarshaler;
				var interfaceContractExceptionCode = (_VMT.createEnvironmentData(_object, out resultMarshaler));
				result = (resultMarshaler==System.IntPtr.Zero) ? null : new Antilatency.Alt.Environment.Sides.Details.IEnvironmentDataWrapper(resultMarshaler);
				HandleExceptionCode(interfaceContractExceptionCode);
				return result;
			}
			public Antilatency.Alt.Environment.Sides.IEnvironmentData deserialize(string environmentData) {
				Antilatency.Alt.Environment.Sides.IEnvironmentData result;
				System.IntPtr resultMarshaler;
		...
		public class ILibraryRemap : Antilatency.Alt.Environment.Details.IEnvironmentConstructorRemap {
			...
			private static Antilatency.InterfaceContract.ExceptionCode createEnvironmentData(System.IntPtr _this, out System.IntPtr result) {
				try {
					...
					result = Antilatency.InterfaceContract.Details.InterfaceMarshaler.ManagedToNative<Antilatency.Alt.Environment.Sides.IEnvironmentData>(resultMarshaler);
				}
				catch (System.Exception ex) {
