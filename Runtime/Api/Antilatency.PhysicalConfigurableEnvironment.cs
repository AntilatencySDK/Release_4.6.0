...
namespace Antilatency.PhysicalConfigurableEnvironment {
	...
	public interface ICotask : Antilatency.DeviceNetwork.ICotask {
		...
		UnityEngine.Vector3 getScreenPosition();
		UnityEngine.Vector3 getScreenX();
		UnityEngine.Vector3 getScreenY();
	}
}
...
namespace Antilatency.PhysicalConfigurableEnvironment {
	namespace Details {
		public class ICotaskWrapper : Antilatency.DeviceNetwork.Details.ICotaskWrapper, ICotask {
			...
			public UnityEngine.Vector3 getScreenPosition() {
				UnityEngine.Vector3 result;
				UnityEngine.Vector3 resultMarshaler;
				var interfaceContractExceptionCode = (_VMT.getScreenPosition(_object, out resultMarshaler));
				result = resultMarshaler;
				HandleExceptionCode(interfaceContractExceptionCode);
				return result;
			}
			public UnityEngine.Vector3 getScreenX() {
				UnityEngine.Vector3 result;
				UnityEngine.Vector3 resultMarshaler;
			...
			public UnityEngine.Vector3 getScreenY() {
				UnityEngine.Vector3 result;
				UnityEngine.Vector3 resultMarshaler;
		...
		public class ICotaskRemap : Antilatency.DeviceNetwork.Details.ICotaskRemap {
			public new struct VMT {
				...
				public delegate Antilatency.InterfaceContract.ExceptionCode getScreenPositionDelegate(System.IntPtr _this, out UnityEngine.Vector3 result);
				public delegate Antilatency.InterfaceContract.ExceptionCode getScreenXDelegate(System.IntPtr _this, out UnityEngine.Vector3 result);
				public delegate Antilatency.InterfaceContract.ExceptionCode getScreenYDelegate(System.IntPtr _this, out UnityEngine.Vector3 result);
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getScreenPosition(System.IntPtr _this, out UnityEngine.Vector3 result) {
				try {
					var obj = GetContext(_this) as ICotask;
					...
					result = default(UnityEngine.Vector3);
					return handleRemapException(ex, _this);
				}
				return Antilatency.InterfaceContract.ExceptionCode.Ok;
			}
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getScreenX(System.IntPtr _this, out UnityEngine.Vector3 result) {
				try {
					var obj = GetContext(_this) as ICotask;
			...
			#endif
			private static Antilatency.InterfaceContract.ExceptionCode getScreenY(System.IntPtr _this, out UnityEngine.Vector3 result) {
				try {
					var obj = GetContext(_this) as ICotask;
