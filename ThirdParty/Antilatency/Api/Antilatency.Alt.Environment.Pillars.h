	...
	namespace Alt {
		namespace Environment {
			namespace Pillars {
				...
				Antilatency::InterfaceContract::ExceptionCode getSchemeByName(const std::string& name, Antilatency::Alt::Environment::Pillars::IScheme& result) {
					return Antilatency::InterfaceContract::ExceptionCode::NotImplemented;
				}
				*/
				struct ILibrary : Antilatency::Alt::Environment::IEnvironmentConstructor {
					...
					Antilatency::InterfaceContract::ExceptionCode getSchemeByName(const std::string& name, Antilatency::Alt::Environment::Pillars::IScheme& result) {
						...
						return (reinterpret_cast<VMT*>(this->_object))->getSchemeByName(nameMarshaler, result);
					}
				};
			} //namespace Pillars
		} //namespace Environment
		...
		namespace Details {
			...
			public:
				...
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL getSchemeByName(Antilatency::InterfaceContract::Details::ArrayInMarshaler::Intermediate name, Antilatency::Alt::Environment::Pillars::IScheme& result) {
					auto exceptionCode_ = this->_object->getSchemeByName(name, result);
					return exceptionCode_;
				}
			};
		} //namespace Details
